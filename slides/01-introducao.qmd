...
- Mostrar como usar o `torch` para ajustar modelos de regressão
- Utilizar o pacote `luz` para ajustar modelos de redes neurais
- Aplicações do `torch` em problemas envolvendo imagens
- Aplicações do `torch` em problemas envolvendo textos e séries de tempo
...
<https://jtrecenti.github.io/2024-torch/>
